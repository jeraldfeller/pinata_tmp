...
class AssetGroupBlock implements AssetGroupBlockInterface
{
    /**
     * @var string
     */
    ...
    /**
     * @var \Vivo\PageBundle\Model\AssetGroupInterface
     */
    protected $model;
     ...
     */
    public function __construct($modelClass, $alias, $name, array $options = array(), $formType)
    {
